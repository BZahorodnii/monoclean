...
import styles from './priceCheckout.module.css';
...
import useGetPriceWithoutSquare from '../../hooks/useGetPriceWithoutSquare';
...
const PriceCheckout: React.FC = () => {
  const { fetch, data } = useGetPriceWithoutSquare();
  const emailRegex = /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i;
  const { fetch: createPaymentIntent, data: paymentIntentData, loading: paymentIntentLoading } = useCreatePaymentIntent();
                  ...
                  <div className={styles.priceInfoContainer}>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        if (orderStep === 1) {
                          setOrderStep(2);
                          fbq('track', 'Cleckout 1 step click', {
                            content_name: 'Cleckout 1 step click',
                            content_category: 'Cleckout 1 step click',
                          });
                        } else {
                          fbq('track', 'Cleckout 2 step click', {
                            content_name: 'Cleckout 1 step click',
                            content_category: 'Cleckout 1 step click',
                          });
                          const formData = {
                  ...
                  <div>
                    <button type="button" className={styles.button} onClick={() => {
                      ...
                      fbq('track', 'Whats included click', {
                        content_name: 'Whats included click',
                        content_category: 'Whats included click',
                      });
                    }}>
                      <Image
