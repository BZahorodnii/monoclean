...
const Airbnb: React.FC = () => {
  ...
  const pageTranslations = convertTranslation(appData?.pagesBlock)?.airbnb;
    ...
    <>
      ...
      <div className={styles.wrapper}>
        ...
        <IsThisYouBlock
          ...
          image="/landings/is-this-you-airbnb.png"
        />
        <IntroducingMonoclean
          ...
          items={items}
        />
        <OrderSteps image3="/landings/order-step-3-airbnb.png" />
